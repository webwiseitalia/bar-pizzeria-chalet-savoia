      ...
      >
        <div className="flex items-center justify-between" style={{ padding: '0 var(--space-gutter)' }}>
          <a href="#" className="relative z-10">
            ...
            <span className="block text-white/40 mt-0.5" style={{ fontFamily: 'var(--font-accent)', fontSize: '0.6rem', letterSpacing: '0.25em', textTransform: 'uppercase' }}>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-40 flex flex-col justify-end pb-20"
          ...
          >
            <div className="px-8 space-y-2">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="block text-white/80 hover:text-white transition-colors border-b border-white/5 py-4"
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="px-8 mt-10 flex gap-4">
              <a href="tel:+393397166992" className="text-white/60 border border-white/20 px-5 py-3" style={{ fontFamily: 'var(--font-accent)', fontSize: '0.7rem', letterSpacing: '0.15em', textTransform: 'uppercase' }}>Chiama</a>
              <a href="https://wa.me/393397166992" target="_blank" rel="noopener noreferrer" className="text-white/60 border border-white/20 px-5 py-3" style={{ fontFamily: 'var(--font-accent)', fontSize: '0.7rem', letterSpacing: '0.15em', textTransform: 'uppercase' }}>WhatsApp</a>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
