          ...
          <div className="hidden lg:flex items-center gap-5 xl:gap-6">
            {navLinks.map((link) => (
              <a
                ...
                style={{ fontFamily: 'var(--font-accent)', fontSize: '0.68rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}
              >
                {link.label}
              </a>
            ))}
            <a
              ...
              className="ml-2 text-white/90 border border-white/20 px-5 py-2 hover:bg-white/10 transition-all duration-500"
